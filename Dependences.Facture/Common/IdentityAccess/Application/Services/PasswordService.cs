...
namespace Facture.IdentityAccess.Application.Services
{
    ...
    public sealed class PasswordService : IPasswordService
    {
        ...
        public bool LookLikeASaltedPassword(string textPassword)
        {
            //Usado para validar contraseñas en los usuarios pagadores
            return (!string.IsNullOrEmpty(textPassword)) ? textPassword.StartsWith("sha1:") : false;
        }
        ...
        {
            Check.NotNull(() => plainTextPassword, "La propiedad 'plainTextPassword' no puede ser null");
